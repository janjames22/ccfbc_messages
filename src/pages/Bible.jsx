  ...
  return (
    <PageContainer>
      ...
      <div style={styles.container}>
        <div className="card-light" style={styles.searchCard}>
...
const styles = {
  ...
  cardTitle: { fontSize: '2rem', fontWeight: '800', marginBottom: '1rem', color: 'var(--text-dark)' },
  cardText: { color: 'var(--muted-dark)', marginBottom: '2.5rem', fontSize: '1.1rem' },
  form: { display: 'flex', flexDirection: 'column', gap: '1.5rem' },
  inputWrapper: { position: 'relative' },
  searchIcon: { position: 'absolute', left: '1.25rem', top: '50%', transform: 'translateY(-50%)' },
  input: { width: '100%', background: 'white', border: '2px solid var(--border-light)', borderRadius: '16px', padding: '1.25rem 1.25rem 1.25rem 3.5rem', color: 'var(--text-dark)', fontSize: '1.2rem', outline: 'none', transition: 'var(--transition)' },
  versionWrapper: { textAlign: 'left', marginTop: '0.5rem' },
  submitBtn: { background: 'var(--primary-blue)', color: 'white', padding: '1.25rem', borderRadius: '16px', fontSize: '1.1rem', fontWeight: '800', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', boxShadow: '0 8px 24px rgba(15, 95, 168, 0.3)', cursor: 'pointer' },
  quickSection: {},
  sectionLabel: { fontSize: '1.1rem', fontWeight: '800', marginBottom: '1.5rem', color: 'var(--silver)', textTransform: 'uppercase', letterSpacing: '1px' },
  ...
  itemRef: { fontWeight: '700', fontSize: '1.1rem', color: 'var(--text-dark)' },
  itemLabel: { fontSize: '0.9rem', color: 'var(--muted-dark)' },
};
